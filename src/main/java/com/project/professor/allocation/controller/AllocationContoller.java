...
public class AllocationContoller {
	...
	public ResponseEntity<Allocation> save(@RequestBody Allocation allocation, Long id ){
		
		allocation.setId(id);
		Allocation alloc = new Allocation();

		alloc.setId((long) 100);
		alloc.setDay(DayOfWeek.SATURDAY);
		alloc.setStart(Time.valueOf(LocalTime.of(8, 00)));
		alloc.setEnd(Time.valueOf(LocalTime.of(17, 00)));
	...
	public ResponseEntity<Allocation> update(@PathVariable(name = "allocation_id") Long id,
		...
		Allocation alloc = new Allocation();
		alloc.setDay(DayOfWeek.SUNDAY);
		alloc.setStart(Time.valueOf(LocalTime.of(9, 00)));
		alloc.setEnd(Time.valueOf(LocalTime.of(18, 00)));
